...
class Lista{
	...
	private void quicksortParcial(int esq, int dir,int k){
		...
		while(i<=j){
			...
			if(esq<j){
				if(i<k){
					if(i<dir) quicksortParcial(i,dir,k);
				}//fim if
				else quicksortParcial(esq,j,k);
			}//fim if
			if(i<dir) quicksortParcial(i,dir,k);
		}//fim while
	}//fim quicksort()
	...
	public void ancestrais(int i){
		for(/**/;i>0;i/=0){
			array[i].printPresidente();
		}//fim for
	}//fim ancestrais
	public void inserirHeap(Presidente  presidente){
		int j=n;
		for(int i = n/=2;i>0;i/=2){
			if (presidente.getIdade() > array[i].getIdade()){
				swap(i,j);
				j/=2;
			}//fim if
			else i=0;
	...
	public int getMaiorFilho(int i, int tam){
		int filho;
		if(2*i == tam || array[2*i].getDataNascimento().getYear()> array[2*i +1].getDataNascimento().getYear()){
			filho=2*i;
		}else filho =2*i+1;
		return filho;
	}//fim getMaiorFilho()
	...
	public void constroi(int tam){
		for(int i = tam; i >1 && (array[i].getDataNascimento().getYear() > array[i/=2].getDataNascimento().getYear()   || ( (array[i].getDataNascimento().getYear() == array[i/=2].getDataNascimento().getYear()) && (array[i].getDataNascimento().getMonthValue() > array[i/=2].getDataNascimento().getMonthValue()) ) || ( (array[i].getDataNascimento().getYear() == array[i/=2].getDataNascimento().getYear()) && (array[i].getDataNascimento().getMonthValue() == array[i/=2].getDataNascimento().getMonthValue()) && (array[i].getDataNascimento().getDayOfMonth() > array[i/=2].getDataNascimento().getDayOfMonth())));i/=2)swap(i,i/=2);
	}//fim constroi
	public void reconstroi(int tam){
		int i=1,filho;
		while(i<=(tam/2)){
			filho=getMaiorFilho(i,tam);
			if(array[i].getDataNascimento().getYear() < array[i/=2].getDataNascimento().getYear()   || ( (array[i].getDataNascimento().getYear() == array[i/=2].getDataNascimento().getYear()) && (array[i].getDataNascimento().getMonthValue() < array[i/=2].getDataNascimento().getMonthValue()) ) || ( (array[i].getDataNascimento().getYear() == array[i/=2].getDataNascimento().getYear()) && (array[i].getDataNascimento().getMonthValue() == array[i/=2].getDataNascimento().getMonthValue()) && (array[i].getDataNascimento().getDayOfMonth() < array[i/=2].getDataNascimento().getDayOfMonth()))){
				swap(i,filho);
				i=filho;
			}else i=tam;
		}//fim while
